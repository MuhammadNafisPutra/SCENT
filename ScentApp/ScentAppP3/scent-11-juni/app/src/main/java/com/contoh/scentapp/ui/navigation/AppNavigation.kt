...
fun AppNavigation(startLoggedIn: Boolean = false) {
    ...
    Scaffold(
        ...
        // SalesViewModel dibuat di sini agar di-share antara SalesScreen & AddProductScreen.
        // Jika dibuat di dalam masing-masing composable, mereka mendapat instance berbeda
        // sehingga produk yang ditambahkan di AddProductScreen tidak muncul di SalesScreen.
        ...
        NavHost(
            ...
            // ── Step 6: Riwayat Pesanan (Pembeli) ────────────────────────────
